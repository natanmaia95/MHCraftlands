package com.nateplays.mhcraftlands.entity.pets.client;// Made with Blockbench 4.11.1
...
import com.nateplays.mhcraftlands.entity.pets.animations.PalicoAnimations;
