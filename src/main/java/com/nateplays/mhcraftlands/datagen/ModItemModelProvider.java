...
//        basicItem(ModItems.CHISEL.get()); //custom model in assets folder
    ...
    private void registerAllPetArmorWeaponItems() {
        ...
        armorItem(MHPetArmorItems.F_DUFFEL_MAIL);
        ...
        armorItem(MHPetArmorItems.F_CREEPER_HELM);
        armorItem(MHPetArmorItems.F_CREEPER_MAIL);
        ...
        armorItem(MHPetArmorItems.F_DIAMOND_HELM);
        armorItem(MHPetArmorItems.F_DIAMOND_MAIL);
        ...
        petWeaponItem(MHPetWeaponItems.F_CREEPER_CLOBBERER);
        ...
        petWeaponItem(MHPetWeaponItems.F_DIAMOND_SWORD);
        petWeaponItem(MHPetWeaponItems.F_VALKYRIE_SWORD);
