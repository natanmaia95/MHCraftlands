package com.nateplays.my_neoforge_mod.entity.pets.client.armor;// Save this class in your mod and generate all required imports
 ...
 * @author Author
 */
public class FFrankieAnimations {
	public static final AnimationDefinition jaw_cycle = AnimationDefinition.Builder.withLength(8.0F).looping()
		.addAnimation("jaw", new AnimationChannel(AnimationChannel.Targets.ROTATION,
			...
			new Keyframe(3.6F, KeyframeAnimations.degreeVec(-10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(7.6F, KeyframeAnimations.degreeVec(10.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
