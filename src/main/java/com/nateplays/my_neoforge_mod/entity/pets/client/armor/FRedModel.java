package com.nateplays.my_neoforge_mod.entity.pets.client.armor;// Made with Blockbench 4.11.2
...
public class FRedModel<T extends PalicoEntity> extends PalicoModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION =
			new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(MyNeoForgeMod.MODID, "f_red_layer"), "main");
